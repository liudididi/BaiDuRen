...
public class ZhiMaScoreViewDown extends View {
    ...
    public ZhiMaScoreViewDown(Context context)
    {
        super(context);
    ...
    public ZhiMaScoreViewDown(Context context, AttributeSet attrs)
    {
        super(context, attrs);
    ...
    public ZhiMaScoreViewDown(Context context, AttributeSet attrs, int defStyleAttr)
    {
