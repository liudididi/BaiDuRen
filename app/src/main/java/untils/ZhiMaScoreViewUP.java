...
public class ZhiMaScoreViewUP extends View {
    ...
    public ZhiMaScoreViewUP(Context context)
    {
        super(context);
    ...
    public ZhiMaScoreViewUP(Context context, AttributeSet attrs)
    {
        super(context, attrs);
    ...
    public ZhiMaScoreViewUP(Context context, AttributeSet attrs, int defStyleAttr)
    {
