...
public class ZhiMaScoreViewXQ extends View {
    ...
    private String[] monthText = new String[]{"A", "S","E","C","R","I"};
    ...
    public ZhiMaScoreViewXQ(Context context)
    {
        super(context);
    ...
    public ZhiMaScoreViewXQ(Context context, AttributeSet attrs)
    {
        super(context, attrs);
    ...
    public ZhiMaScoreViewXQ(Context context, AttributeSet attrs, int defStyleAttr)
    {
